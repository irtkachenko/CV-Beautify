...
- `lib/resume-list-store.ts` - canonical client-side resume list cache helpers
...
- Unified resume-card client state around a single `ResumesListResponse` cache instead of multiple local list variants.
